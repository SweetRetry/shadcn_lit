import { getDepositConfig, getWalletNetwork } from "@/api/my/wallet";
...
import "./records/ex-deposit-hisotry";

import { ExForm } from "@/components/ui/ex-form/ex-form";

import { DepositConfig, WalletNetwork } from "@/api/my/wallet/types";
...
export class ExDeposit extends TailwindElement {
  ...
  render() {
    return html` <section class="h-full">
      <h2 class="text-2xl font-semibold">Deposit</h2>
      ...
      <div class="mt-4">
        <div class="flex justify-between">
          <h2 class="text-2xl font-semibold">Recent Deposits</h2>
          <app-link
